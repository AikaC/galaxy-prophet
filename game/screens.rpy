        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("Pós-escolha") action Preference("after choices", "toggle")
            ...
            hbox:
                ...
                vbox:
                    ...
                    if config.has_sound:
                        ...
                        label _("Volume Efeitos Sonoros")
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Avança com o diálogo e ativa a interface.")

    hbox:
        label _("Barra de Spaço")
        text _("Avança com o diálogo sem selecionar escolhas.")
    ...
    hbox:
        label _("Ctrl")
        text _("Enquanto pressionado, pula o diálogo.")

    hbox:
        label _("Tab")
        text _("Alterna diálogo pulado.")
    ...
    hbox:
        label "V"
        text _("Alterna a assistência {a=https://www.renpy.org/l/voicing}self-voicing{/a}.")
...
screen mouse_help():
    ...
    hbox:
        label _("Botão esquerdo do mouse")
        text _("Avança o diálogo e ativa a interface.")

    hbox:
        label _("Botão do meio do mouse")
        text _("Esconde a interface do usuário.")

    hbox:
        label _("Botão direito do mouse")
